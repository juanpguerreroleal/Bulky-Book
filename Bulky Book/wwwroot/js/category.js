                ...
                "render": function (data) {
                    return `
                        <div class="text-center">
                            ...
                            <a class="btn btn-sm btn-success" href="/Admin/Category/Upsert/${data}"><i class="fas fa-edit"></i>Edit</a>
                        </div>`;
                },
                "width": "40%"
            }
...
function Delete(id) {
    ...
    swal({
        title: "Are you sure?",
        text: "You're about to remove the category, this action can't be reverted, are you sure?",
        icon: "warning",
